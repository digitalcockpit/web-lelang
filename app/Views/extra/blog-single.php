    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 mr-auto"><h4 class="mb-0">Single Post</h4></div>
                ...
                <div class="col-12 col-xl-9 mb-5 mb-xl-0">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="media d-block d-sm-flex text-center text-sm-left p-4 ml-0 ml-sm-5 border-top theme-border">
                            <img class="img-fluid d-md-flex mr-sm-4 rounded-circle" src="<?php echo base_url('dist/images/author9.jpg');?>" alt="">
                            <div class="media-body align-self-center">
                                <div class="float-sm-right float-none h6 mb-0 my-3 my-sm-0"> <a href="#" class="text-primary"> <i class="icofont icofont-bubble-left pr-1"></i> Reply</a> </div>  
                        ...
                        <div class="media d-block d-sm-flex text-center text-sm-left p-4 border-top them-border">
                            <img class="img-fluid d-md-flex mr-sm-4 rounded-circle" src="<?php echo base_url('dist/images/author1.jpg');?>" alt="">
                            <div class="media-body align-self-center">
                                <div class="float-sm-right float-none h6 mb-0 my-3 my-sm-0"> <a href="#" class="text-primary"> <i class="icofont icofont-bubble-left pr-1"></i> Reply</a> </div>  
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="media d-block d-sm-flex text-center text-sm-left mb-4">
                                <img class="img-fluid d-md-flex mr-sm-4" src="<?php echo base_url('dist/images/author1.jpg');?>" alt="">
                            ...
                            <div class="media d-block d-sm-flex text-center text-sm-left mb-4">
                                <img class="img-fluid d-md-flex mr-sm-4" src="<?php echo base_url('dist/images/author10.jpg');?>" alt="">
                                <div class="media-body align-self-center redial-line-height-1_5">
                                    <h6 class="my-2 my-sm-0 redial-line-height-1_5 mb-xl-2">Maecenas tempus tellus eget luctus.</h6>
                                    15 Dec 2017
                                </div>
                            ...
                            <div class="media d-block d-sm-flex text-center text-sm-left mb-4">
                                <img class="img-fluid d-md-flex mr-sm-4" src="<?php echo base_url('dist/images/author9.jpg');?>" alt="">
                                <div class="media-body align-self-center redial-line-height-1_5">
                                    <h6 class="my-2 my-sm-0 redial-line-height-1_5 mb-xl-2">Maecenas tempus tellus eget luctus.</h6>
                                    25 Dec 2017
                                </div>
