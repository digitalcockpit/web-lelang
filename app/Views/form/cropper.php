...
<div class="row ">
    <div class="col-12  align-self-center">
        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
            <div class="w-sm-100 mr-auto"><span class="h4 my-auto">Form Cropper</span></div>

            <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                <li class="breadcrumb-item">Home</li>
                <li class="breadcrumb-item">Form</li>
                <li class="breadcrumb-item active"><a href="#">Cropper</a></li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="img-container">
                            <img src="<?php echo base_url('dist/images/picture.jpg');?>" alt="Picture">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <!-- <h3>Preview:</h3> -->
...
<!-- START: Page CSS-->
<link rel="stylesheet"  href="<?php echo base_url('dist/vendors/cropperjs/cropper.min.css'); ?>">
<!-- END: Page CSS-->
<?= $this->endSection() ?>
<?= $this->section('pagescript') ?>
<!-- START: Page JS-->
<script src="<?php echo base_url('dist/vendors/cropperjs/cropper.min.js'); ?>"></script>
<script src="<?php echo base_url('dist/js/cropper.script.js'); ?>"></script>
<!-- END: Page JS-->
<?= $this->endSection() ?>
